    ...
    >
        <div class="row g-3 mb-3">
            ...
            <form-group-field
                ...
                :description="$gettext('Note: This should be the public-facing homepage of the radio station, not the URL for this panel. It will be included in broadcast details.')"
            />
