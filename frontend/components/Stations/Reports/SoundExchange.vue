        ...
        >
            <div class="card-body">
                <form-fieldset>
                    ...
                    <ul>
                        <li>
                            We assumes that your station fits SoundExchange Transmission Category A, "Eligible
                        ...
                        <li>
                            The data collected by the system meets the SoundExchange standard for Actual Total
                        ...
                        <li>
                            You should always verify the report generated before sending it. In particular,
                ...
                <form-fieldset class="row">
                    ...
                    >
                        ...
                        <template #description>
                            {{
                                $gettext('If enabled, We will connect to the MusicBrainz database to attempt to find an ISRC for any files where one is missing. Disabling this may improve performance.')
                            }}
                        </template>
                    </form-group-checkbox>
                </form-fieldset>
