...
final class Settings implements Stringable
{
    ...
    #[
        OA\Property(description: "Site Base URL", example: "https://your.casterfm.site"),
    ...
    #[
        OA\Property(description: "Casterfm Instance Name", example: "My Casterfm Instance"),
        ORM\Column(length: 255, nullable: true),
        Serializer\Groups(self::GROUP_GENERAL)
    ]
    ...
    #[
        OA\Property(description: "Hide Casterfm Branding on Public Pages", example: "false"),
        ORM\Column,
        Serializer\Groups(self::GROUP_BRANDING)
    ]
    ...
    #[
        OA\Property(description: "The name of the sender of system e-mails.", example: "Casterfm"),
        ORM\Column(length: 255, nullable: true),
        Serializer\Groups(self::GROUP_GENERAL)
    ]
